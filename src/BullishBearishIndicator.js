...
const BullishBearishIndicator = (props) => {
    return (
        <div style={{ borderTop: 'solid 1px #232323', display: 'grid', gridColumn: '1 / span 4', gridTemplateColumns: '5fr 5fr 5fr 5fr 5fr 5fr 5fr 10fr', paddingTop: '4px', paddingBottom: '7px', color: '#454545' }}>
